...
public class DegreeController extends HttpServlet {
    /**
     * POST, http://49.234.223.174:8080/degree.ctl, 增加学位
    ...
    /**
     * PUT, http://49.234.223.174:8080/degree.ctl, 修改学位
     *
    ...
    /**
     * GET, http://49.234.223.174:8080/degree.ctl?id=1, 查询id=1的学位
     * GET, http://49.234.223.174:8080/degree.ctl, 查询所有的学位
     * 把一个或所有学位对象响应到前端
     * @param request
     * @param response
     * @throws ServletException
