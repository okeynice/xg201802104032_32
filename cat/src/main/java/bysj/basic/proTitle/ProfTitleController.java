...
public class ProfTitleController extends HttpServlet {
    /**
     * POST, http://49.234.223.174:8080/profTitle.ctl, 增加职称
    ...
    /**
     * DELETE, http://49.234.223.174:8080/profTitle.ctl?id=1, 删除id=1的职称
    ...
    /**
     * PUT, http://49.234.223.174:8080/profTitle.ctl, 修改职称
     *
    ...
    /**
     * GET, http://49.234.223.174:8080/profTitle.ctl?id=1, 查询id=1的职称
     * GET, http://49.234.223.174:8080/profTitle.ctl, 查询所有的职称
     * 把一个或所有职称对象响应到前端
     * @param request
     * @param response
     * @throws ServletException
